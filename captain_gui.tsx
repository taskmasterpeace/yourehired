                          ...
                          <Card className="bg-white overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow">
                            ...
                            <CardContent className="space-y-4 p-6">
                              <div>
                                ...
                                <p className="text-gray-700 ml-5 mt-1">{selectedOpportunity.location || "Not specified"}</p>
                              </div>
                              ...
                              <div>
                                ...
                                <p className="text-gray-700 ml-5 mt-1 font-medium">{selectedOpportunity.salary || "Not specified"}</p>
                              </div>
                              ...
                              <div>
                                ...
                                <p className="text-gray-700 ml-5 mt-1">{selectedOpportunity.source || "Not specified"}</p>
                              </div>
                              ...
                              <div>
                                ...
                                {selectedOpportunity.applicationUrl ? (
                                  ...
                                  <p className="text-gray-500 italic ml-5 mt-1">Not specified</p>
                                )}
                              </div>
                            </CardContent>
                          </Card>
                          ...
                          <Card className="bg-white overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow">
                            ...
                            <CardContent className="space-y-4 p-6">
                              <div>
                                ...
                                <p className="text-gray-700 ml-5 mt-1 font-medium">{selectedOpportunity.recruiterName || "Not specified"}</p>
                              </div>
