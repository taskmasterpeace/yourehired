...
export function AchievementNotification({
  ...
  const getIcon = () => {
    switch (achievement.category) {
      case 'milestones': return <Trophy className="h-6 w-6" />;
      case 'consistency': return <Zap className="h-6 w-6" />;
      case 'quality': return <Star className="h-6 w-6" />;
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h3 className={cn('font-medium', colors.text)}>Achievement Unlocked!</h3>
