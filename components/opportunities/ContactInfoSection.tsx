  ...
  return (
    <div className={`p-4 mb-4 rounded-lg border ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
      <div className="flex justify-between items-center mb-4">
        <h3 className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Contact Information</h3>
        {!isEditing ? (
          <Button 
            variant="ghost" 
            size="sm" 
        ...
        <div className="space-y-3">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setEditedContact({...editedContact, recruiterName: e.target.value})}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setEditedContact({...editedContact, recruiterEmail: e.target.value})}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setEditedContact({...editedContact, recruiterPhone: e.target.value})}
