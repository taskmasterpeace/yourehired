...
export const OpportunityList = ({
  ...
  const handleItemClick = (opp: Opportunity, index: number) => {
              ...
              <div className="flex-1">
                <Select value={dateFilter} onValueChange={setDateFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Last 7 Days">Recent (7 days)</SelectItem>
            ...
            <Button
              ...
              onClick={() => {
                ...
                if (isBatchSelectMode) {
                  ...
                  // Use -1 as a signal to clear all selections
                ...
                return (
                  <div key={opp.id} className="relative">
                    ...
                    <Card
                      ...
                      onClick={() => handleItemClick(opp, index)}
                    >
