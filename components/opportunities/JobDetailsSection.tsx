...
interface JobDetailsSectionProps {
  ...
  // Update the id parameter type from number to string | number
  updateOpportunity: (
    id: string | number,
        ...
        <div className="space-y-3">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setEditedDetails({ ...editedDetails, location: e.target.value })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setEditedDetails({ ...editedDetails, salary: e.target.value })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setEditedDetails({ ...editedDetails, source: e.target.value })
              }
