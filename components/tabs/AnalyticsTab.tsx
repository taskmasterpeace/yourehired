...
export function AnalyticsTab({
  ...
  const [achievementRulesPanelOpen, setAchievementRulesPanelOpen] =
    useState(false);
  ...
  const timelineData =
    analytics.applicationTimeline?.[
      timelinePeriod as keyof ApplicationTimeline
    ] || [];
  ...
  const convertTimelineData = (period: string): TimelineDataPoint[] => {
    return (
      analytics.applicationTimeline?.[period as keyof ApplicationTimeline] || []
    ).map((item) => ({
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="core" className="w-full">
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-xl flex items-center">
                  Total Applications
                  <TooltipHelper
                    content={localTooltipContent.totalApplications}
                  />
                </CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-lg">
                        Oldest Application: Company XYZ
                      </h4>
                      <p className="text-muted-foreground mt-1">
                        Applied 30 days ago - No response yet
                      </p>
                      <p className="mt-2">
                        Consider following up or marking as inactive
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-lg">
                        5 Applications Without Activity
                      </h4>
                      <p className="text-muted-foreground mt-1">
                        No updates for more than 14 days
                      </p>
                      <div className="mt-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mt-1">
                          You add the most opportunities on this day
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-lg">
                          Most Applications: Thursday
                        </h4>
                        <p className="text-muted-foreground mt-1">
                          You submit the most applications on this day
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle className="text-xl flex items-center">
                    Application Timeline
                    <TooltipHelper
                      content={localTooltipContent.applicationTimeline}
                    />
                  </CardTitle>
                  <CardDescription>
            ...
            <CardContent>
              <div className="mb-6">
                <div className="flex items-center mb-2">
                  ...
                  <TooltipHelper content="Key insights about your job applications" />
                </div>
                ...
                <div className="overflow-x-auto pb-4">
                  <div className="min-w-[800px]">
                    ...
                    <div className="mt-4">
                      {opportunities
                        .filter((opp) => opp.status)
                        .map((opp, i) => {
                          const statusIndex = Object.keys(
                            STATUS_COLORS
                          ).indexOf(opp.status);
                          const position =
                            statusIndex > 7 ? 100 : (statusIndex / 8) * 100;
                            ...
                            <div key={i} className="relative h-8 mb-2">
                              <div
                                ...
                                style={{
                                  ...
                                  backgroundColor:
                                    STATUS_COLORS[
                                      opp.status as keyof typeof STATUS_COLORS
                                    ] || "#64748b",
                                }}
                              >
                  ...
                  <div className="min-w-[600px]">
                    <div className="relative pt-2 pb-10">
                      ...
                      <div className="relative pl-6 mb-4">
                        <div
                          className={`absolute left-0 w-2.5 h-2.5 rounded-full bg-green-500`}
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground mt-1">
                                You customized your resume for this role
                              </p>
                            </div>
                      ...
                      <div className="relative pl-6 mb-4">
                        <div
                          className={`absolute left-0 w-2.5 h-2.5 rounded-full bg-blue-500`}
                          style={{ top: "50%", transform: "translateY(-50%)" }}
                        ></div>
                        <div
                          className={`p-3 rounded-lg border ${
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <div>
                              <span className="font-medium">
                                Received response from InnovateTech
                              </span>
                              <p className="text-sm text-muted-foreground mt-1">
                                They've scheduled a screening call
                              </p>
                            </div>
                            <span className="text-xs text-muted-foreground">
                              Yesterday
                      ...
                      <div className="relative pl-6 mb-4">
                        <div
                          className={`absolute left-0 w-2.5 h-2.5 rounded-full bg-purple-500`}
                          style={{ top: "50%", transform: "translateY(-50%)" }}
                        ></div>
                        <div
                          className={`p-3 rounded-lg border ${
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <div>
                              <span className="font-medium">
                                Completed technical assessment for DevSolutions
                              </span>
                              <p className="text-sm text-muted-foreground mt-1">
        ...
        <TabsContent value="gamification" className="space-y-6">
                ...
                <div className="flex items-center gap-6 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg mt-3">
                      {analytics.jobSearchStats.totalScore || 0} points • Next
                      level at {analytics.jobSearchStats.nextLevelScore || 100}{" "}
                      points
                    </p>
                  </div>
                </div>
          ...
          {/* Weekly Challenges */}
          {analytics.weeklyChallenges &&
            analytics.weeklyChallenges.length > 0 && (
              <Card
                className={`${isDarkMode ? "bg-gray-800 border-gray-700" : ""}`}
              >
                <CardHeader>
                  <CardTitle className="text-xl flex items-center">
                    Weekly Challenges
                    <TooltipHelper
                      content={localTooltipContent.weeklyChallenges}
                    />
                  </CardTitle>
                  <CardDescription className="text-base">
              ...
              >
                <CardHeader>
                  <CardTitle className="text-xl flex items-center">
                    Level Benefits
                    <TooltipHelper
                      content={localTooltipContent.levelBenefits}
                    />
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <LevelBenefitsExplainer
                    ...
                    nextLevelScore={
                      analytics.jobSearchStats.nextLevelScore || 100
                    }
                    isDarkMode={isDarkMode}
                  />
                </CardContent>
