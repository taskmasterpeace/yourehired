...
console.log("LOADING COMPONENT: CalendarQRModal.jsx - VERSION 2");
...
const CalendarQRModal = ({ event, isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-red-500 dark:bg-red-800 border dark:border-gray-700 shadow-lg">
        <DialogHeader>
